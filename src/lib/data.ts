...
export const users: User[] = [
  { id: '1', name: 'Arash Shams', email: 'arash.shams@example.com', avatarUrl: 'https://picsum.photos/seed/user1/100/100', status: 'online', department: 'Engineering', bio: 'Full-Stack Developer', extension: '1234' },
